...
export const HELP_TOPICS: readonly HelpTopic[] = [
  {
    ...
    lines: [
      `${APP_CONFIG.name} lets this server create markets, trade YES/NO shares with REP, and settle outcomes when results are known.`,
      "",
      "Start here:",
      "- `/account register` - Create your account",
      "- `/market create` - Create a draft market",
      "- `/market open` - Open a market for trading",
      "- `/market buy` - Buy YES or NO shares",
  ...
  },
  {
    ...
    lines: [
      ...
      "- `target_shares` - Exact number of shares to buy.",
      "",
      "Examples:",
      ...
      "",
      "Note: prices can move as trades execute. Your final shares depend on current market price.",
    ],
  },
  {
    id: "market sell",
  ...
  },
  {
    ...
    title: "/position",
    lines: [
      "Use position commands to see shares you currently hold.",
      "",
      "Commands:",
      "- `/position list` - See your open positions",
    ],
...
export const GLOSSARY_TERMS: readonly GlossaryTerm[] = [
  {
    ...
    detail: [
      ...
      "",
      "You spend REP to buy shares. Your balance changes when trades execute, markets settle, or an admin adjusts your account.",
      "",
  ...
  },
  {
    ...
    detail: [
      ...
      "",
      "Buy YES shares when you think the market will resolve YES.",
    ],
  },
  {
    id: "no",
    ...
    detail: [
      ...
      "",
      "Buy NO shares when you think the market will resolve NO.",
    ],
  },
  {
    id: "contract",
    aliases: ["contracts"],
    title: "Contract",
    summary: "The YES or NO outcome instrument in a market.",
    detail: [
      "A contract is the YES or NO outcome instrument in a market.",
      "",
      "Shares are units of a contract. If you buy YES shares, you hold part of the YES contract.",
    ],
  },
  {
    id: "share",
    aliases: ["shares"],
    title: "Share",
    summary: "A unit of an outcome contract.",
    detail: [
      "A share is a unit of an outcome contract.",
      "",
      "If you buy YES shares, your YES position grows. If you buy NO shares, your NO position grows.",
    ],
  },
  {
    id: "position",
    aliases: ["positions"],
    title: "Position",
    summary: "Shares you currently hold in a market.",
    detail: [
      "A position is the shares you currently hold in a market.",
      "",
  ...
  },
  {
    ...
    detail: [
      ...
      "",
      "Resolution determines payouts for YES or NO shares.",
    ],
  },
  {
    id: "cancelled",
  ...
  },
  {
    ...
    detail: [
      ...
      "",
      "The number of shares depends on current market price.",
    ],
  },
  {
    id: "target shares",
    ...
    title: "Target shares",
    summary: "Trade mode where you choose the number of shares.",
    detail: [
      "Target shares is a trade mode where you choose the exact number of shares to buy.",
      "",
